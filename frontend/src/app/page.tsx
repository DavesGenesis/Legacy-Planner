                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 mt-4 border-t border-gray-600">
                    ...
                    <div className="space-y-4">
                      <div>
                        <div className="flex justify-between mb-1">
                          <label className="text-xs text-gray-300">Sum Assured (Death Benefit)</label>
                      ...
                      <div className="bg-gray-800 bg-opacity-40 p-2 rounded flex justify-between items-center">
                        <label className="text-xs text-gray-400 font-medium">Payment Term Assumption</label>
                        <span className="text-xs font-medium highlight">10 Years</span>
                      </div>
                    </div>
                  </div>
                </div>
